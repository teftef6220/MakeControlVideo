...
import numpy as np
from . import util
from dwpose.body  import Body, BodyResult, Keypoint
...
import warnings
from .draw_pose_util import HWC3, resize_image_with_pad, common_input_validate, custom_hf_download
import cv2
...
class DwposeDetector:
    ...
    def __call__(self, input_image, detect_resolution=512, include_body=True, include_hand=True, include_face=True, hand_and_face=None, output_type="pil", image_and_json=False, upscale_method="INTER_CUBIC", xinsr_stick_scaling=False, **kwargs):
